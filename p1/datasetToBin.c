...
void lineToSong(char *line, struct Song *song){
    ...
    while(token){
        ...
        switch (field){
            case 0: strncpy(song->artist, token, ARTIST_MAX); break;
            case 1: strncpy(song->name, token, NAME); break;
            case 2: strncpy(song->text, token, TEXT); break;
            case 3: strncpy(song->length, token, ARTIST_MAX); break;
            case 4: strncpy(song->emotion, token, ARTIST_MAX); break;
            case 5: strncpy(song->genre, token, ARTIST_MAX); break;
            case 6: strncpy(song->album, token, NAME); break;
            case 7: strncpy(song->date, token, NAME); break;
        }
...
int main(){
    ...
    char buffer[15000]; //Para poder leer una linea (No estoy seguro del tamaño xd)
